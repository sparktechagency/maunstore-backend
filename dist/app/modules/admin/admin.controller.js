...
const createAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.AdminServices.createAdminToDB(userData);
...
const getAdmins = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield admin_service_1.AdminServices.getAdminsFromDB();
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const updateAdmin = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.AdminServices.updateAdminToDB(id, updatedPayload);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
...
const updateAdminStatus = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield admin_service_1.AdminServices.updateAdminStatusToDB(id, status);
    (0, sendResponse_1.default)(res, {
        success: true,
        statusCode: 200,
